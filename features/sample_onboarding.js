...
module.exports = function(controller) {
    ...
    confirmation.say('Your name is {{vars.profile.name}}, your age is {{vars.profile.age}} and your location is {{vars.profile.location}}'); // the value is come from the profile dialog 
